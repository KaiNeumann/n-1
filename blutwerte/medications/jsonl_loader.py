"""
blutwerte.medications.jsonl_loader

Loads Medication objects from knowledge/medications/medications.jsonl.
Falls back to the Python source in blutwerte/medications/data/*.py
...
def load_medications_from_python() -> Dict[str, Medication]:
    """Load medications by walking blutwerte.medications.data."""
