# Blutwerte Food System

Comprehensive food data system with nutrition information, biomarker effects, and source tracking for the Blutwerte blood test analysis platform.

## Quick Start

```python
from blutwerte.foods import Food, FoodDatabase, gramm, scheibe
...
The food system is included in Blutwerte. No additional installation required.
...
```python
from blutwerte.foods import Food, DataSource, FoodEffect
...
```python
from blutwerte.foods import gramm, scheibe, glas, portion
...
```python
from blutwerte.foods import compare_to_rdi
...
```python
from blutwerte.foods.importers import setup_bls_importer
...
pytest blutwerte/foods/tests/test_food_data.py -v

# Run with coverage
pytest blutwerte/foods/tests/ --cov=blutwerte.foods
```
...
Part of the Blutwerte project. See main project license.
