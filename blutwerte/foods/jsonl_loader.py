"""
blutwerte.foods.jsonl_loader

Loads Food objects from knowledge/foods/*.jsonl. Falls back to the
Python source in blutwerte/foods/data/ when the JSONL is missing.
"""
...
FOOD_DATA_PACKAGE = "blutwerte.foods.data"
...
def load_foods_from_python() -> Dict[str, Food]:
    """Load foods by walking blutwerte.foods.data and the legacy package."""
    out: Dict[str, Food] = {}
    try:
