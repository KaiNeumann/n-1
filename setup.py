...
setup(
    ...
    version="0.2.0",
    author="Kai Uwe",
    description="N=1: a Python library for personal health analysis - blood biomarkers, medications, foods, activities, and patient profiles, all for the only n that matters.",
