...
def example_load_and_query():
    ...
    code = '''
from core.foods.importers import FooDBImporter
...
def example_biomarker_mapping():
    ...
    code = '''
from core.foods.importers import FooDBMapper
...
def example_enrich_food():
    ...
    code = '''
from core.foods.importers import FooDBImporter, FooDBMapper
from core.foods.models import FoodEffect, EffectCertainty
from core.medications.models import EffectTargetType, EffectDirection
from core.foods.sources import create_source
...
def example_available_mappings():
    ...
    from core.foods.importers import COMPOUND_CLASS_TO_BIOMARKERS
