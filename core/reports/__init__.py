...
Example Usage:
    >>> from core.reports import HealthReportGenerator
    >>> 
...
class PDFReport(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 10, 'core Health Report', 0, 1, 'C')
        self.ln(5)
...
class HealthReportGenerator:
    ...
    def _generate_use_cases(self, pdf: PDFReport):
        ...
        pdf.set_text_color(0, 0, 0)
        pdf.multi_cell(0, 6, "This section explains how you can use the core system to "
        ...
        pdf.multi_cell(0, 5, "Your health is a personal journey. The core system helps you:\n")
